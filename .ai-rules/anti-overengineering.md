...
- Use the language standard library before adding a dependency.
...
actually necessary for the current milestone.
...
- security,
- data isolation (when the target app requires it),
- input validation,
- error handling,

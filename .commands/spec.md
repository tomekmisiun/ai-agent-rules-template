...
**Work request:**  
<PASTE USER REQUEST OR BACKLOG ITEM HERE>
...
3. Produce a spec with these sections:
   ...
   - Risks (security, migrations, deploy)
   - Verification plan (commands from `.ai-rules/validation.md`)
...
Output the spec in markdown. Keep it concise and specific to this repository's architecture.
